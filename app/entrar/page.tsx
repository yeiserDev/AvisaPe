...
export default function Entrar() {
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col justify-center gap-3 p-3">
      <div className="halo rounded-bloque px-7 pb-9 pt-8 text-white">
      ...
      <form onSubmit={enviar} className="rounded-bloque bg-white p-6">
        <label
        ...
        <input
          ...
          className="mt-1.5 w-full rounded-campo border border-borde bg-lienzo/60 px-4 py-3 text-base focus:border-senal focus:bg-white focus:outline-none"
        />
        ...
        <button
          type="submit"
          disabled={ocupado}
          className="mt-6 w-full rounded-full bg-senal py-4 font-semibold text-white transition-opacity disabled:opacity-50"
        >
